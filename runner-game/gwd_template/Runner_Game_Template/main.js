...
class Play extends Phaser.Scene {
    ...
    if (this.finishLine) {
      ...
      this.tweens.add({
        ...
        onComplete: () => {
          ...
          // Esperar 1 segundo y terminar el juego
      ...
      // Sin línea de meta, solo mover el jugador hacia adelante
  ...
  spawnObstacle() {
    ...
    // Obtener origin configurables (por defecto 0.5, 0.5 = centrado)
    const originX = obstacleType.originX !== undefined ? obstacleType.originX : 0.5;
    const originY = obstacleType.originY !== undefined ? obstacleType.originY : 0.5;
    ...
    if (obstacleType.isAnimated) {
      ...
      obstacle = this.obstaclesGroup.create(width + 50, y, obstacleType.key)
        ...
        .setOrigin(originX, originY) // Origin configurable desde config
